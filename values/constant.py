...
DB_TOPIC_REWARD_RULES = 'reward_rules'
# Comment related
DB_PROOF = "comments_proof"
DB_PARTICIPATION = "comments_participation"
DB_AUTHOR = "comments_author"
DB_COMMENTS_UPDATE = 'comments_update'
