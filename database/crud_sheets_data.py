...
def insert_proof_comments(sheet_id, topic_id, sheet_name, data):
    try:
        ...
        postgres_insert_query = """ INSERT INTO """ + constant.TABLE_NAME_GOOGLE_SHEETS + """(row, sheet_id, topic_id, sheet_name, timestamp, forum_username, profile_link, social_media_username, followers) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"""
