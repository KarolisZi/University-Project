...
def populate_database_main_page(check, database_table_name, url):
    # Create database table
    create_table.create_home_page_database(database_table_name)
    ...
    match check:
        case "one":
            ...
            create_one_page_post_records_in_database(database_table_name, url)
        case "all":
            create_all_post_records_in_database(database_table_name, url)
...
def populate_database_comment_page(check, database_table_name):
    ...
    create_table.create_comments_database(database_table_name)

    match check:
        case "one_one":
            create_one_post_one_page_comment_records_in_database(data, database_table_name)
        case "one_all":
            create_one_post__all_pages_comment_records_in_database(data, database_table_name)
        case "all_all":
            create_all_post_all_pages_comment_records_in_database(data, database_table_name)